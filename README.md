...
- Single strategic map state with units, owners, turn state, selectable units, reachable movement, ZOC flags, and integer-scaled movement costs. The first combat units are cavalry, infantry, and horde.
