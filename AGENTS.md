...
- Current combat-capable unit kinds are cavalry, infantry, and horde. Cavalry has move `4`, infantry has move `2`, and horde has move `3`. Cavalry, infantry, and horde project ZOC; infantry and horde respect enemy ZOC, while cavalry currently ignores it.
