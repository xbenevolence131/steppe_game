...
- Roads route from hex center to hex center and are emitted in top-level `roads` as coordinate paths. The browser draws them in brown. Current roads connect Persian towns and Chinese towns in nearest-neighbor regional chains while avoiding lake hexes.
